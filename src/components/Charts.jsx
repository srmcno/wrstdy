    ...
    chartRef.current = new Chart(ref.current, {
      ...
      data: {
        ...
        datasets: [
          ...
          { label: 'Expenses (Proposed Budget)', data: proj.propExpArr || proj.expArr, backgroundColor: '#1E3D3B', borderRadius: 4, borderWidth: 0, type: 'line', borderColor: '#1E3D3B', tension: .3, pointRadius: 4, fill: false },
          { label: 'Expenses (Current Budget)', data: proj.curExpArr || proj.expArr, backgroundColor: '#64748b', borderRadius: 4, borderWidth: 0, type: 'line', borderColor: '#64748b', borderDash: [5, 3], tension: .3, pointRadius: 3, fill: false }
        ]
      },
      options: {
        responsive: true, maintainAspectRatio: false,
